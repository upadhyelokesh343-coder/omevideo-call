...
type Gateway = 'stripe' | 'paypal' | 'crypto' | 'razorpay';
...
const PayPalLogo = () => (
  <svg width="24" height="28" viewBox="0 0 24 28" fill="none">
    <path d="M18.75 8.16667C18.75 12.3333 16.0833 14.5 12.5833 14.5H8.58333L7.25 22.8333H3.08333L6.08333 3.5H12.5833C16.0833 3.5 18.75 5.66667 18.75 8.16667Z" fill="#003087"/>
    <path d="M21.25 10.6667C21.25 14.8333 18.5833 17 15.0833 17H11.0833L9.75 25.3333H5.58333L8.58333 6H15.0833C18.5833 6 21.25 8.16667 21.25 10.6667Z" fill="#009CDE"/>
    <path d="M12.5833 14.5C16.0833 14.5 18.75 12.3333 18.75 8.16667C18.75 5.66667 16.0833 3.5 12.5833 3.5H6.08333L3.08333 22.8333H7.25L8.58333 14.5H12.5833Z" fill="#012169"/>
  </svg>
);
...
const PayPalLogoBadge = () => (
  <div className="h-4 px-1.5 bg-white rounded-md flex items-center justify-center border border-white/10 shadow-sm shrink-0">
    <div className="flex items-center gap-0.5">
      <span className="text-[7px] font-black text-[#003087] select-none leading-none italic font-sans">Pay</span>
      <span className="text-[7px] font-black text-[#0079C1] select-none leading-none italic font-sans">Pal</span>
    </div>
  </div>
);
...
export function VIPModal({ isOpen, onClose, onUpgrade, type }: VIPModalProps) {
  ...
  const handleProceed = () => {
    ...
    else if (selectedGateway === 'paypal') handlePayPalPayment();
                  ...
                  <div className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      ...
                      >
                        ...
                        <div className="text-left flex-1 flex flex-col justify-center">
                          <div className="text-[9px] sm:text-[10px] font-black text-white uppercase tracking-[0.1em]">PayPal Checkout</div>
                          <div className="text-[7px] sm:text-[8px] text-slate-500 font-bold uppercase tracking-tighter italic mb-1.5">Express Global</div>
                          <div className="flex flex-wrap items-center gap-1.5">
                            <PayPalLogoBadge />
                            <VisaLogoBadge />
                            <MastercardLogoBadge />
                        ...
                        {selectedGateway === 'paypal' && <Check size={14} className="text-blue-500" />}
                      </button>
