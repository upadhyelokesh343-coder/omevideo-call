                ...
                <div className="text-center space-y-4">
                  <div className="flex flex-col items-center justify-center gap-10">
                    <img 
                      ...
                      alt="OMIX Logo" 
                      className="w-72 h-72 lg:w-[36rem] lg:h-[36rem] object-contain drop-shadow-[0_0_100px_rgba(139,92,246,0.6)] rounded-[4.5rem] lg:rounded-[10rem]" 
                    />
                    <h1 className="text-4xl lg:text-6xl font-black tracking-tight uppercase brand-omix leading-none">
                      OMIX
                    </h1>
                  </div>
